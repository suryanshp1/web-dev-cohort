    ...
    return new Promise((resolve) => {
        ...
        const server = app.listen(0, async () => {
            ...
            try {
                ...
                const menuData = await menuData.json()
...
function block_2_response() {
    return new Promise((resolve) => {
        ...
        app.get('/old-menu', (req, res) => {
            // add entry to db to see how many users are still visiting old routes
        ...
        app.get('/custom-headers', (req, res) => {
            ...
            res.set('X-powered-Id', '12');
            res.json({
                message: 'Custom headers set'
            })
            // CORS, caching, tracing, ratelimiting
        })
